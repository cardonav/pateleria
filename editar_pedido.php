...
$id = $_GET['id'];
$pedido = obtenerPedidoPorId($conn, $id);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (actualizarPedido($conn, $id, $datos)) {
...
<body>
    <div class="container">
        <header>
            <h1><i class="fas fa-edit"></i> Editar Pedido #<?php echo $pedido['id']; ?></h1>
            <p>Modifique los datos del pedido</p>
        </header>
        ...
        <div class="form-container">
            <div class="precios-info">
                ...
                <p>Total Actual: <strong>$<?php echo number_format($pedido['total'], 2); ?></strong></p>
            </div>
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="text" id="nombre_cliente" name="nombre_cliente" class="form-control" 
                           value="<?php echo htmlspecialchars($pedido['nombre_cliente']); ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="pastel_basico">Cantidad Pastel Básico</label>
                    <input type="number" id="pastel_basico" name="pastel_basico" class="form-control" 
                           min="0" value="<?php echo $pedido['pastel_basico']; ?>">
                </div>
                
                <div class="form-group">
                    <label for="pastel_mediano">Cantidad Pastel Mediano</label>
                    <input type="number" id="pastel_mediano" name="pastel_mediano" class="form-control" 
                           min="0" value="<?php echo $pedido['pastel_mediano']; ?>">
                </div>
                
                <div class="form-group">
                    <label for="pastel_grande">Cantidad Pastel Grande</label>
                    <input type="number" id="pastel_grande" name="pastel_grande" class="form-control" 
                           min="0" value="<?php echo $pedido['pastel_grande']; ?>">
                </div>
